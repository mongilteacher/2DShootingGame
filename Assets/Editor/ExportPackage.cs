...
public static class ExportPackage
{
    ...
    {
        string[] projectContent = new string[] { "Assets", "ProjectSettings/TagManager.asset", "ProjectSettings/InputManager.asset", "ProjectSettings/ProjectSettings.asset", "ProjectSettings/PhysicsManager.asset", "ProjectSettings/Physics2DSettings.asset"};
